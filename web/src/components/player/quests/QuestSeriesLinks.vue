...
<template>
  <section v-if="series.length > 0" class="lb quest-series-card" :class="{ 'is-collapsed': collapsed }">
    <div class="lb-head">
      ...
      <div class="quest-series-controls">
        ...
        <label class="quest-series-hide-completed quest-series-pin-mode" :class="{ 'is-active': pinMode }" title="Pin questlines to the front of this row">
          ...
          <svg class="pin-mode-icon" viewBox="0 0 384 512" aria-hidden="true" focusable="false">
            <path
    ...
    <div v-if="!collapsed && visibleSeries.length > 0" class="quest-series-links">
      ...
      >
        <svg v-if="s.pinRank !== null" class="quest-series-link-pin" viewBox="0 0 384 512" aria-hidden="true" focusable="false">
          <path
            d="M32 32C32 14.3 46.3 0 64 0L320 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-29.5 0 11.4 148.2c36.7 19.9 65.7 53.2 79.5 94.7l1 3c3.3 9.8 1.6 20.5-4.4 28.8s-15.7 13.3-26 13.3L32 352c-10.3 0-19.9-4.9-26-13.3s-7.7-19.1-4.4-28.8l1-3c13.8-41.5 42.8-74.8 79.5-94.7L93.5 64 64 64C46.3 64 32 49.7 32 32zM160 384l64 0 0 96c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-96z"
          />
        </svg>
